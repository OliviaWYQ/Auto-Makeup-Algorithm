...
tf.flags.DEFINE_string('X_input_dir', 'data/before2after/aff_A_512',
                       'X input directory, default: data/before2after/aff_A_512') #new
tf.flags.DEFINE_string('Y_input_dir', 'data/before2after/aff_B_512',
                       'Y input directory, default: data/before2after/aff_B_512') #new
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/before.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/before.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/after.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/after.tfrecords')
