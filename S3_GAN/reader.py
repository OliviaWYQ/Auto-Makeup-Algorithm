...
class Reader():
  def __init__(self, tfrecords_file, image_size=512,
    min_queue_examples=1000, batch_size=2, num_threads=8, name=''): #new
    """
    Args:
...
def test_reader():
  TRAIN_FILE_1 = 'data/tfrecords/before.tfrecords'
  TRAIN_FILE_2 = 'data/tfrecords/after.tfrecords'
