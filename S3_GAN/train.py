...
tf.flags.DEFINE_integer('image_size', 512, 'image size, default: 256') #new
...
tf.flags.DEFINE_string('X', 'data/tfrecords/before.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/before.tfrecords')
tf.flags.DEFINE_string('Y', 'data/tfrecords/after.tfrecords',
                       'Y tfrecords file for training, default: data/tfrecords/after.tfrecords')
